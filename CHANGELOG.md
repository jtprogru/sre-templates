...
- `changelog.ru.yaml` — языковой вариант артефакта для `srekit changelog --lang ru`
  (появился в srekit `v0.32.0`).
...
- CI: запиненный srekit поднят до `v0.32.0`, версия печатается через `--version`.
